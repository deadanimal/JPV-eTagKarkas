                ...
                <div class="card-body">
                    ...
                    <form action="/tag" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="bil_kodbar"
                                    id="bilangan_kodbar" readonly />
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mt-2">
                            ...
                            <div class="col-md-6">
                                <input type="text" id="myInput" class="form-control"
                                    placeholder="Sila Masukkan Nama Premis ">
                            </div>
                            <div class="col-md-3">
                        ...
                        <tr>
                            ...
                            @foreach ($tags as $tag)
                                ...
                                @role('pentadbir')
                                    <td>
                                        <div class="col-auto">
                                            <a href="/tag/{{ $tag->id }}" class="btn btn-sm btn-success">Semak<i
                                                    class="fas fa-eye"></i></a>
                                        </div>

                                    </td>
                                    <td>
                                        <button type="submit" class="btn btn-sm btn-outline-success" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal"><i class="fas fa-print"></i></button>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <img src="/img/barkod.png" alt="error" width="550"
                                                            height="93">
                                ...
                                @role('pengurus-rumah-sembelih')
                                    ...
                                    <td>
                                        <div class="col-auto">
                                            <a href="/tag/{{ $tag->id }}" class="btn btn-sm btn-success"><i
