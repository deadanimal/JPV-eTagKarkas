                    ...
                    <div class="card-body">
                        ...
                        <form action="/tag/senarai_tag/stok" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-xl-10">
                                    <input class="form-control" type="number" name="tag_diterima" id="tag_diterima" value=100 onchange="changeTag()" />
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-xl-10">
                                    <input class="form-control" type="number" name="tag_rosak" id="tag_rosak" value=0 onchange="changeTag()" />
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-xl-10">
                                    <input class="form-control" type="number" name="tag_bolehpakai" id="tag_bolehpakai" readonly />
                                </div>
                            </div>                            
