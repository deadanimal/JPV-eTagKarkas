               ...
               <strong>
                ...
                <body class="content">
                    ...
                    <div>
                        ...
                        <br><br> 1. Rumah Sembelih : <b>{{$jana_harian->pemeriksaan_harian_babi->nama_premis}}</b>
                        ...
                        <br><br> a. Jumlah Binatang Yang Diperiksa :  <b>{{$jana_harian->pemeriksaan_harian_babi->bil_ternakan_diterima}}</b>
                        <br><br> b. Jumlah Binatang Yang Diluluskan Sebagai Layak Untuk Disembelih : <b>{{$jana_harian->pemeriksaan_harian_babi->jumlah_binatang_layak_disembelih}}</b>
                        <br><br> c. Jumlah Binatang Yang Dibenarkan Untuk Disembelih tetapi Berada Dibawah Pemeriksaan Rapi : <b>{{$jana_harian->pemeriksaan_harian_babi->bilangan_diasingkan_pemeriksaan_rapi}}</b>
