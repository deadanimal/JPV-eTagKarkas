...
<main class="content">
    ...
    <div class="tab mt-1">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item" style="background-color: aquamarine"><a class="nav-link " href="#tab-5" data-bs-toggle="tab" role="tab">Tag Karkas</a></li>
        </ul>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-1" role="tabpanel">
               ...
               <form action="">
                <div class="card-header">
                    <b>Pemeriksaan Daging > Pengenalan Ternakan</b>
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <form action="">
                            <div class="card">
                               ...
                               <div class="card-body">
                                    ...
                                    <div class="mb-3 col-md-3">
                                        <label for="">Jumlah binatang yang dikondem pada pemeriksaan ante mortem</label>
