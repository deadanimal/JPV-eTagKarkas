                                ...
                                <form action="#" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <textarea class="form-control" rows=5 name="syarikat" onkeyup="this.value = this.value.toUpperCase();" required readonly
                                        ...
                                        <div class="col md-6 ms-auto">
                                            ...
                                            <textarea class="form-control" rows=5 name="alamat" onkeyup="this.value = this.value.toUpperCase();" required readonly
                                    ...
                                    <strong>Dengan ini kami pihak kami mengaku bahawa susu tepung yang berkuantiti <input type="number" name="kg" placeholder="KG" onkeyup="this.value=this.value.replace(/(?![0-9])./gmi,'')" min="0" readonly value="{{$perakuan->kg}}">
                                        dengan Batch No: <input type="text" name="batch" onkeyup="this.value = this.value.toUpperCase();" value="{{$perakuan->batch}}" readonly> adalah disingkirkan disebabkan oleh:
                                    </strong>
