...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('pemeriksaan_babi_harians', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('babi_id')->references('id')->on('pengenalan_babis') ->onUpdate('cascade')
            ->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('pemeriksaan_babi_harians');
    }
};
